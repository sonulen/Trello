        ...
        mBoardView.setBoardListener(object : BoardView.BoardListener {
            ...
            override fun onItemDragEnded(fromColumn: Int, fromRow: Int, toColumn: Int, toRow: Int) {
                if (fromColumn != toColumn || fromRow != toRow) {
                    Toast.makeText(context, "End - column: " + toColumn + " row: " + toRow, Toast.LENGTH_SHORT).show()
                }
            }
            ...
            override fun onItemChangedPosition(
                ...
                Toast.makeText(mBoardView.context, "Position changed - column: " + newColumn + " row: " + newRow, Toast.LENGTH_SHORT).show()
            }
